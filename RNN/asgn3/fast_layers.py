import numpy as np
try:
  from asgn3.im2col_cython import col2im_cython, im2col_cython
  from asgn3.im2col_cython import col2im_6d_cython
except ImportError:
  print 'run the following from the asgn3 directory and try again:'
  print 'python setup.py build_ext --inplace'
  print 'You may also need to restart your Jupyter kernel'

from asgn3.im2col import *
